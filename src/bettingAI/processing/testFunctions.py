...
def test_statistics(session):
    ...
    try:
        ...
        print(
            Fore.RED + f"        get_average_goals_season() {tested}/{len(toTest)} -> {e}"
        )
    ...
    try:
        for teamID, season in toTest:
            ...
            tested += 1
        print(
            Fore.GREEN + f"        get_average_conceded_season() {tested}/{len(toTest)} ✅"
        )
    except Exception as e:
        print(
            Fore.RED
            + f"        get_average_conceded_season() {tested}/{len(toTest)} -> {e}"
        )
    ...
    try:
        for teamID, season in toTest:
            ...
            tested += 1
        print(
            Fore.GREEN + f"        get_average_goaldiff_season() {tested}/{len(toTest)} ✅"
        )
    except Exception as e:
        print(
            Fore.RED
            + f"        get_average_goaldiff_season() {tested}/{len(toTest)} -> {e}"
        )
...
def test_recent_form(session):
    ...
    try:
        ...
        print(
            Fore.RED + f"        get_outcome_streak() {tested}/{len(toTestRecent)} -> {e}"
        )
...
def test_h2h(session):
    ...
    try:
        for teamID, opponentID, date in toTestH2H:
            ...
            tested += 1
        print(
            Fore.GREEN + f"        get_outcome_distribution() {tested}/{len(toTestH2H)} ✅"
        )
    except Exception as e:
        print(
            Fore.RED
            + f"        get_outcome_distribution() {tested}/{len(toTestH2H)} -> {e}"
        )
    ...
    try:
        ...
        print(
            Fore.RED + f"        get_side_distribution() {tested}/{len(toTestH2H)} -> {e}"
        )
    ...
    try:
        ...
        print(
            Fore.RED + f"        get_recent_encounters() {tested}/{len(toTestH2H)} -> {e}"
        )
    ...
    try:
        ...
        print(
            Fore.GREEN
            + f"        get_average_goals_per_match() {tested}/{len(toTestH2H)} ✅"
        )
    except Exception as e:
        print(
            Fore.RED
            + f"        get_average_goals_per_match() {tested}/{len(toTestH2H)} -> {e}"
        )
    ...
    try:
        ...
        print(
            Fore.GREEN
            + f"        get_average_goals_conceded_per_match() {tested}/{len(toTestH2H)} ✅"
        )
    except Exception as e:
        print(
            Fore.RED
            + f"        get_average_goals_conceded_per_match() {tested}/{len(toTestH2H)} -> {e}"
        )
    ...
    try:
        ...
        print(
            Fore.GREEN
            + f"        get_average_goals_difference_match() {tested}/{len(toTestH2H)} ✅"
        )
    except Exception as e:
        print(
            Fore.RED
            + f"        get_average_goals_difference_match() {tested}/{len(toTestH2H)} -> {e}"
        )
    ...
    try:
        ...
        print(
            Fore.RED + f"        get_clean_sheet_rate() {tested}/{len(toTestH2H)} -> {e}"
        )
    ...
    try:
        for teamID, opponentID, date in toTestH2H:
            ...
            tested += 1
        print(
            Fore.GREEN + f"        get_outcome_streak_h2h() {tested}/{len(toTestH2H)} ✅"
        )
    except Exception as e:
        print(
            Fore.RED
            + f"        get_outcome_streak_h2h() {tested}/{len(toTestH2H)} -> {e}"
        )
...
def test_player_info(session):
    ...
    try:
        for teamID, _ in toTest:
            ...
            tested += 1
        print(
            Fore.GREEN + f"        get_average_player_rating() {tested}/{len(toTest)} ✅"
        )
    except Exception as e:
        print(
            Fore.RED
            + f"        get_average_player_rating() {tested}/{len(toTest)} -> {e}"
        )
    ...
    try:
        ...
        print(
            Fore.RED + f"        get_average_player_age() {tested}/{len(toTest)} -> {e}"
        )
    ...
    try:
        for teamID, _ in toTest:
            ...
            tested += 1
        print(
            Fore.GREEN + f"        get_average_player_height() {tested}/{len(toTest)} ✅"
        )
    except Exception as e:
        print(
            Fore.RED
            + f"        get_average_player_height() {tested}/{len(toTest)} -> {e}"
        )
    ...
    try:
        ...
        print(
            Fore.RED + f"        get_average_player_value() {tested}/{len(toTest)} -> {e}"
        )
